"""
MDL Example: Ranking Network with MDL-based evidence penalty.

This example demonstrates how to use mdl_evidence_penalty to set the evidence penalty for a predicate on the network output.
"""
...
from ranking_network import network

def pred(state):
    # Example: require all True
    return all(state)

ranking = list(network())
